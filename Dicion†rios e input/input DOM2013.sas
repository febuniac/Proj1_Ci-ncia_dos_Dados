/*     PROGRAMA DE LEITURA EM SAS DO ARQUIVO DE MICRODADOS DE DOMICÍLIOS
    DA PNAD 2013 - PESQUISA BÁSICA E SUPLEMENTARES DE SEGURANÇA ALIMENTAR
	               E DE ACESSO À INTERNET E À TELEVISÃO                  */
...
INPUT 		@00001          V0101          $4.          /*Ano de referência*/
            ...
            @00210          V2103          $1.          /*Os moradores tiveram a preocupação de que os alimentos acabassem antes de poderem comprar ou receber mais comida*/
            @00211          V2105          $1.          /*Os alimentos acabaram antes que os moradores deste domicílio tivessem dinheiro para comprar mais comida*/
            @00212          V2107          $1.          /*Os moradores ficaram sem dinheiro para ter uma alimentação saudável e variada*/
            @00213          V2109          $1.          /*Os moradores comeram apenas alguns alimentos que ainda tinham porque o dinheiro acabou*/
            @00214          V2113          $1.          /*Algum morador de 18 anos ou mais de idade deixou de fazer alguma refeição porque não havia dinheiro para comprar comida*/
            @00215          V2115          $1.          /*Algum morador de 18 anos ou mais de idade, alguma vez, comeu menos do que achou que devia porque não havia dinheiro para comprar comida*/
            @00216          V2117          $1.          /*Algum morador de 18 anos ou mais de idade, alguma vez, sentiu fome mas não comeu porque não havia dinheiro para comprar comida*/
            @00217          V2121          $1.          /*Algum morador de 18 anos ou mais de idade, alguma vez, fez uma refeição ou ficou um dia inteiro sem comer porque não havia dinheiro para comprar comida*/
            @00218          V2123          $1.          /*Existência de morador de 0 a 17 anos de idade*/
            @00219          V2124          $1.          /*Algum morador com menos de 18 anos de idade, alguma vez, deixou de ter uma alimentação saudável e variada porque não havia dinheiro para comprar comida*/
            @00220          V2126          $1.          /*Algum morador com menos de 18 anos de idade, alguma vez, não comeu quantidade suficiente de comida porque não havia dinheiro para comprar comida*/
            @00221          V2128          $1.          /*Alguma vez, foi diminuida a quantidade de alimentos das refeições de algum morador com menos de 18 anos de idade porque não havia dinheiro para comprar comida*/
            @00222          V2130          $1.          /*Alguma vez, algum morador com menos de 18 anos de idade deixou de fazer uma refeição porque não havia dinheiro para comprar comida*/
            @00223          V2132          $1.          /*Alguma vez, algum morador com menos de 18 anos de idade sentiu fome, mas não comeu porque não havia dinheiro para comprar comida*/
            @00224          V2134          $1.          /*Alguma vez, algum morador com menos de 18 anos de idade fez apenas uma refeição ao dia ou ficou sem comer por um dia inteiro porque não havia dinheiro para comprar comida*/
			@00225          V2138          $2.          /*Principal atutide adotada quando faltou alimento*/
		    @00227          V2139          $2.          /*Outra atitude adotada quando faltou alimento*/
			@00229          V9992          $8.          /*Data de geração do arquivo de microdados*/
			;
run;
